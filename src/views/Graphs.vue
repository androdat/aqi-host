...
export default {
  ...
  async mounted() {
    ...
    let res = await axios.get(
      `https://api.worldweatheronline.com/premium/v1/past-weather.ashx?tp=24&q=Bengaluru&date=${startdate}&enddate=${enddate}&key=72a817dfff484ce6bd7140017211807&format=json`
    );
